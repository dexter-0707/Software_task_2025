...
class Card(pygame.sprite.Sprite):
	...
	def __init__(self, color, color_hover, rect, callback, text='', outline=None):
		...
		self.image.blit(pygame.transform.smoothscale(a, (210,300)), (0,0))
...
sprites.add(Card(pygame.Color('yellow'),
				pygame.Color('red'),
